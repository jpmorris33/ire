...
#define IREKEY_0_PAD             SDLK_KP0
#define IREKEY_1_PAD             SDLK_KP1
#define IREKEY_2_PAD             SDLK_KP2
#define IREKEY_3_PAD             SDLK_KP3
#define IREKEY_4_PAD             SDLK_KP4
#define IREKEY_5_PAD             SDLK_KP5
#define IREKEY_6_PAD             SDLK_KP6
#define IREKEY_7_PAD             SDLK_KP7
#define IREKEY_8_PAD             SDLK_KP8
#define IREKEY_9_PAD             SDLK_KP9
...
#define IREKEY_PRTSCR            SDLK_PRINT
#define IREKEY_PAUSE             SDLK_BREAK
#define IREKEY_YEN               -1
...
#define IREKEY_LWIN              SDLK_LSUPER
#define IREKEY_RWIN              SDLK_RSUPER
#define IREKEY_MENU              -1
#define IREKEY_SCRLOCK           SDLK_SCROLLOCK
#define IREKEY_NUMLOCK           SDLK_NUMLOCK
