...
int billalert3(const char *s1, const char *s2, const char *s3, const char *b1, const char *b2,
                   const char *b3, int c1, int c2, int c3);
int billalert(const char *s1, const char *s2, const char *s3, const char *b1, const char *b2,
                   int c1, int c2);
