...
int billalert3(const char *s1, const char *s2, const char *s3, const char *b1, const char *b2, const char *b3, int c1, int c2, int c3)
{
   int maxlen = 0;
   int len1, len2, len3;
   ...
   #define SORT_OUT_BUTTON(x) {                                            \
      if (b##x) {                                                          \
         ...
         billalert_dialog[A_B##x].dp = (void *)b##x;                                   \
   ...
   if (s1) {
      billalert_dialog[A_S1].dp = (void *)s1;
      maxlen = text_length(font, s1);
   }

   if (s2) {
      billalert_dialog[A_S2].dp = (void *)s2;
   ...
   if (s3) {
      billalert_dialog[A_S3].dp = (void *)s3;
...
int billalert(const char *s1, const char *s2, const char *s3, const char *b1, const char *b2, int c1, int c2)
{
   int ret;
