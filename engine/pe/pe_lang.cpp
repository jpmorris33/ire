...
//                    {"setarray",PEVM_SetArray,"c=(",PE_checkaccess,NULL,1},
                    ...
                    {"push_object",PEVM_PushObject,"c?Ii",PE_generic,NULL,3},
                    {"push_object",PEVM_PushObject,"c?II",PE_generic,NULL,3},
                    {"transfer_object",PEVM_Xfer2Object,"o?o",PE_generic,NULL,2},
                    {"transfer_object",PEVM_Xfer2Object,"o?O",PE_generic,NULL,2},
                    {"transfer_object",PEVM_Xfer2Object,"o?c",PE_generic,NULL,2},
                    {"transfer_object",PEVM_Xfer2Object,"O?o",PE_generic,NULL,2},
                    {"transfer_object",PEVM_Xfer2Object,"O?O",PE_generic,NULL,2},
                    {"transfer_object",PEVM_Xfer2Object,"O?c",PE_generic,NULL,2},
                    {"transfer_object",PEVM_Xfer2Object,"c?o",PE_generic,NULL,2},
                    {"transfer_object",PEVM_Xfer2Object,"c?O",PE_generic,NULL,2},
                    {"transfer_object",PEVM_Xfer2Object,"c?c",PE_generic,NULL,2},
                    ...
                    {"get_cost",PEVM_GetTileCost,"a?nI",PE_checkaccess,NULL,3},
                    {"get_cost",PEVM_GetTileCost,"a?In",PE_checkaccess,NULL,3},
                    {"get_cost",PEVM_GetTileCostFor,"i?nn?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"i?ni?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"i?in?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"i?ii?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"i?iI?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"i?Ii?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"i?II?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"i?nI?o",PE_checkaccess,NULL,4},
                    ...
                    {"get_cost",PEVM_GetTileCostFor,"I?nI?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"I?In?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?nn?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?ni?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?in?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?ii?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?iI?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?Ii?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?II?o",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?nI?o",PE_checkaccess,NULL,4},
                    ...
                    {"get_cost",PEVM_GetTileCostFor,"a?nI?O",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?In?O",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"i?nn?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"i?ni?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"i?in?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"i?ii?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"i?iI?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"i?Ii?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"i?II?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"i?nI?c",PE_checkaccess,NULL,4},
                    ...
                    {"get_cost",PEVM_GetTileCostFor,"I?nI?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"I?In?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?nn?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?ni?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?in?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?ii?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?iI?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?Ii?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?II?c",PE_checkaccess,NULL,4},
                    {"get_cost",PEVM_GetTileCostFor,"a?nI?c",PE_checkaccess,NULL,4},
                    ...
                    {"move_to_pocket",PEVM_MoveToPocket,"o?O",PE_generic,NULL,2},
                    {"move_to_pocket",PEVM_MoveToPocket,"o?c",PE_generic,NULL,2},
                    {"move_to_pocket",PEVM_MoveToPocket,"O?o",PE_generic,NULL,2},
                    {"move_to_pocket",PEVM_MoveToPocket,"O?O",PE_generic,NULL,2},
                    {"move_to_pocket",PEVM_MoveToPocket,"O?c",PE_generic,NULL,2},
                    {"move_to_pocket",PEVM_MoveToPocket,"c?o",PE_generic,NULL,2},
                    {"move_to_pocket",PEVM_MoveToPocket,"c?O",PE_generic,NULL,2},
                    {"move_to_pocket",PEVM_MoveToPocket,"c?c",PE_generic,NULL,2},
                    {"transfer_to_pocket",PEVM_XferToPocket,"o?o",PE_generic,NULL,2},
                    {"transfer_to_pocket",PEVM_XferToPocket,"o?O",PE_generic,NULL,2},
                    {"transfer_to_pocket",PEVM_XferToPocket,"o?c",PE_generic,NULL,2},
                    {"transfer_to_pocket",PEVM_XferToPocket,"O?o",PE_generic,NULL,2},
                    {"transfer_to_pocket",PEVM_XferToPocket,"O?O",PE_generic,NULL,2},
                    {"transfer_to_pocket",PEVM_XferToPocket,"O?c",PE_generic,NULL,2},
                    {"transfer_to_pocket",PEVM_XferToPocket,"c?o",PE_generic,NULL,2},
                    {"transfer_to_pocket",PEVM_XferToPocket,"c?O",PE_generic,NULL,2},
                    {"transfer_to_pocket",PEVM_XferToPocket,"c?c",PE_generic,NULL,2},
                    ...
                    {"check_time",PEVM_CheckTimeI,"i",PE_generic,NULL,1},
                    {"check_time",PEVM_CheckTimeI,"I",PE_generic,NULL,1},
                    {"check_time",PEVM_CheckTimeI,"a",PE_generic,NULL,1},
                    {"check_time",PEVM_CheckTime,"",PE_generic,NULL,0},
                    {"check_date",PEVM_CheckDateI,"i",PE_generic,NULL,1},
                    {"check_date",PEVM_CheckDateI,"I",PE_generic,NULL,1},
                    {"check_date",PEVM_CheckDateI,"a",PE_generic,NULL,1},
                    ...
                    {"find_between",PEVM_FindBetween,"c=s?oo",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=s?Oo",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=s?co",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=S?oo",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=S?Oo",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=S?co",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=P?oo",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=P?Oo",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=P?co",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=s?oO",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=s?OO",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=s?cO",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=S?oO",PE_checkaccess,NULL,4},
                    ...
                    {"find_between",PEVM_FindBetween,"c=P?OO",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=P?cO",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=s?oc",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=s?Oc",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=s?cc",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=S?oc",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=S?Oc",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=S?cc",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=P?oc",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=P?Oc",PE_checkaccess,NULL,4},
                    {"find_between",PEVM_FindBetween,"c=P?cc",PE_checkaccess,NULL,4},
